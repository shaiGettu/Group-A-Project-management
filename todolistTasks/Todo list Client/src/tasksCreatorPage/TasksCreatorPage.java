...
public class TasksCreatorPage extends JFrame {
    ...
    public TasksCreatorPage() {
        ...
        submitTaskButton.addActionListener(e-> {
            ...
            if (!isValidDate(dueDate)) {
                ...
                try {
                    String  result = AddTask("Shai",title, dueDate, text, priority,Status);
    ...
    private String AddTask(String user, String title, String dueDate, String text, String priority,String Status) throws IOException {
        ...
        URL url = new URL("http://localhost/todolistTasks/todolistTasksPhp/include/CreateTask.php");
        URLConnection connection = url.openConnection();
        connection.setDoOutput(true);
        PrintStream ps = new PrintStream(connection.getOutputStream());
        ps.print("u= ShaiGettu");
        ps.print("&ti=" + title);
        ps.print("&du=" + dueDate);
        ps.print("&te=" + text);
        ps.print("&p=" + priority);
