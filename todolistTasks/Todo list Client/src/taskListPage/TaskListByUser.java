...
import tasksCreatorPage.TasksCreatorPage;
...
public class TaskListByUser extends JFrame {
    ...
    private void initialize() throws IOException {
        JLabelUser.setText("Tasks by Shai Gettu");
        ...
        count=1;
        String line = connectServer("GetTasks","u=ShaiGettu");
    ...
    private String connectServer(String phpFile,String send) throws IOException {
        ...
        URL url = new URL("http://localhost/todolistTasks/todolistTasksPhp/include/"+phpFile+".php");
