package ToDoList.taskListPage;

import org.json.simple.JSONObject;
import org.json.simple.JSONValue;
import ToDoList.tasksCreatorPage.TasksCreatorPage;
import ToDoList.ViewTaskPage.ViewTaskPage;
...
public class TaskListByUser extends JFrame {
    ...
    public TaskListByUser(String email) throws IOException {
        initialize(email);
    ...
    private void deleteTask(String title) throws IOException {
        ...
        mainFrame.dispose();
        new TaskListByUser(staticEmail);
    }

    private void initialize(String email) throws IOException {
        staticEmail = email;
    ...
    private String connectServer(String phpFile,String send) throws IOException {
        ...
        URL url = new URL("http://localhost/myfiles/ToDoList/include/"+phpFile+".php");
    ...
    public static void launch(String email) throws IOException {
        new TaskListByUser(email);
    }
}